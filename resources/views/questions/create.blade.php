...
<head>
    ...
    <style>
        ...
        input, textarea{width:100%;padding:10px;border:1px solid #ddd;border-radius:8px;font-size:16px}
...
طائرة بدون طيار
درون
طائرة مروحية">{{ old('keywords') }}</textarea>
                    <small>تُستخدم لرفع التطابق اللفظي. لا تُرسل للـ embedding.</small>
                </div>
...
في=يوجد
لوكيشن=موقع
الطريق=الوصول">{{ old('lex_map') }}</textarea>
